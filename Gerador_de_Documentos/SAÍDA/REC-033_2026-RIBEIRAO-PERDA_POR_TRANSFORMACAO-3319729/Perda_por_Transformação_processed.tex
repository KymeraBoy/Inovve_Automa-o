...
\item A Unidade Consumidora \unidadeConsumidora{}, de titularidade do Município e devidamente enquadrada na classificação \textbf{B3 -- PODER PÚBLICO MUNICIPAL}, vem sendo faturada indevidamente com a cobrança de perdas técnicas oriundas de transformador, prática que carece inteiramente de amparo legal e regulatório para o seu grupo de faturamento. O enquadramento da unidade consumidora pode ser verificado na imagem abaixo.

% ===== IMAGEM IDENTIFICAÇÃO =====
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{C:/Users/Usuário 1/OneDrive/PASTA ENERGIA 1/Municípios HLA - Outros Estados/Pernambuco/Ribeirão/Reclamações/PERDA POR TRANSFORMAÇÃO/identificacao.png}
\end{figure}
% ===============================

\item A distribuidora fundamenta a referida cobrança com base no art. 305 da Resolução Normativa nº 1.000/2021 da ANEEL. Ademais, a própria concessionária informa que está aplicando o percentual de \textbf{2,5\%} referente às perdas técnicas, conforme demonstrado na imagem a seguir.

% ===== IMAGEM COMPROVAÇÃO =====
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{C:/Users/Usuário 1/OneDrive/PASTA ENERGIA 1/Municípios HLA - Outros Estados/Pernambuco/Ribeirão/Reclamações/PERDA POR TRANSFORMAÇÃO/Cmprovação.png}
\end{figure}
% ==============================

\item Todavia, a leitura do caput do referido dispositivo evidencia a sua inaplicabilidade ao Grupo B:
...
\item Sendo o transformador de propriedade exclusiva da concessionária e ativo integrante da rede de distribuição de uso comum, as perdas técnicas decorrentes da transformação de energia não podem ser repassadas individualmente ao consumidor de baixa tensão na fatura de energia. O consumo efetivamente registrado pelo medidor pode ser observado na imagem abaixo.

% ===== IMAGEM CONSUMO =====
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{C:/Users/Usuário 1/OneDrive/PASTA ENERGIA 1/Municípios HLA - Outros Estados/Pernambuco/Ribeirão/Reclamações/PERDA POR TRANSFORMAÇÃO/consumo.png}
\end{figure}
% ==========================

\item Entretanto, verifica-se que o faturamento considera valor superior ao efetivamente medido, em razão da indevida aplicação do acréscimo referente às perdas técnicas, conforme demonstrado na imagem a seguir.

% ===== IMAGEM FATURAMENTO =====
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{C:/Users/Usuário 1/OneDrive/PASTA ENERGIA 1/Municípios HLA - Outros Estados/Pernambuco/Ribeirão/Reclamações/PERDA POR TRANSFORMAÇÃO/faturado.png}
\end{figure}
% ==============================
