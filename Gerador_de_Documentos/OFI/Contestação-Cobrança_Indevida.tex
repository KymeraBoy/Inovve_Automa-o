...
\hline
Mês    & \begin{tabular}[c]{@{}l@{}}Período de\\ leitura da\\ fatura\end{tabular} & \begin{tabular}[c]{@{}l@{}}N° de\\ dias\end{tabular} & \begin{tabular}[c]{@{}l@{}}Consumo cobrado\\ na fatura\\ (kWh)\end{tabular} & \begin{tabular}[c]{@{}l@{}}Consumo QIP\\ (kWh)\end{tabular} & \begin{tabular}[c]{@{}l@{}}Diferença\\ cobrada a maior\\ (kWh)\end{tabular} \\ \hline
MAR/24 & 01/03/2024 a 31/03/2024                                                  & 31                                                   & 137.640,00                                                                  & 115.857,00                                                  & 21.783,00                                                                   \\
MAI/25 & 01/05/2024 a 31/05/2024                                                  & 31                                                   & 115.873,00                                                                  & 59.995,00                                                   & 55.878,00                                                                   \\ \hline
       &                                                                          &                                                      &                                                                             & TOTAL                                                       & 77.661,00                                                                   \\ \hline
\end{tabular}
\end{table}
...
\item Diante do exposto, requer-se:
    ...
    \item Que a concessionária seja compelida a disponibilizar o histórico completo de consumo dos últimos <<CONTADOR_MESES>> meses da referida unidade consumidora ou, alternativamente, ao menos uma fatura correspondente ao mês de dezembro de cada ano desse período.
    \end{enumerate}
\end{enumerate}