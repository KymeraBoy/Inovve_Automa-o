...
\newcommand{\protocolo}{010.607.10526-45}
% Comando para o tipo de reclamação (padrão: RECLAMAÇÃO xxx)
\newcommand{\reclamacao}{REC 036\_2025 - SÃO JOSÉ MAMEDE - PERDAS NOS REATORES}
% Comando para a data (padrão: Mês de ano)
\newcommand{\data}{setembro de 2025}
...
Embora a concessionária tenha reconhecido e apurado valores cobrados indevidamente ao longo de todo o período de 10 (dez) anos, a devolução em dobro foi aplicada apenas aos valores referentes ao período de 08/2025 a 09/2020, desconsiderando os valores apurados entre 08/2020 e 09/2015.
