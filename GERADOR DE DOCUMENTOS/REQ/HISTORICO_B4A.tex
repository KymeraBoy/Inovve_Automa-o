...
Perante o exposto, solicita-se a concessionária que forneça o \textbf{histórico de consumo e faturamento} da unidade consumidora agregadora dos pontos de iluminação pública (IP) faturados por estimativa, sob a modalidade tarifária B4a (acervo municipal), referente aos últimos \textbf{<<CONTADOR_MESES>> meses}, contendo, no mínimo, a discriminação dos valores faturados em kWh e em reais (R\$).
