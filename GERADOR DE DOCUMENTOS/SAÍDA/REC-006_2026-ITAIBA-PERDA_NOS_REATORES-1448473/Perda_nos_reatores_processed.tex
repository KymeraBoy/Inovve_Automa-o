...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{C:/Users/Usuário 1/OneDrive/00 - Arquivos antigos/Documentos/Arthur Castro/QIP - Itaíba/Perdas-Vapor.png}
\end{figure} % VAPOR
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{C:/Users/Usuário 1/OneDrive/00 - Arquivos antigos/Documentos/Arthur Castro/QIP - Itaíba/Perdas-Fluorescente.png}
\end{figure} % FLUORESCENTE
\fi

\item
Os dados e quantitativos acima apresentados foram extraídos do Quadro de Iluminação Pública – QIP, referente a Desembro de 2020, em anexo, documento elaborado e utilizado pela própria Concessionária como base de cálculo para o faturamento mensal da unidade consumidora da classe Iluminação Pública. Ressalta-se que referido faturamento é realizado por estimativa, a partir das informações constantes no QIP, circunstância que reforça a necessidade de estrita observância dos limites técnicos e regulatórios aplicáveis, bem como evidencia a responsabilidade exclusiva da Concessionária pela correção dos parâmetros adotados.

\item
Diante do exposto, apura-se a ocorrência de cobrança indevida correspondente a 318,66 kWh/mês, relativa ao parque de iluminação pública considerado no Quadro de Iluminação Pública – QIP. Projetado tal excedente para o período de 120 (cento e vinte) meses, equivalente a 10 (dez) anos, o montante total indevidamente faturado perfaz 38.239,20 kWh. Nos termos do art. 323 da Resolução Normativa ANEEL nº 1.000/2021 e do art. 42, parágrafo único, do Código de Defesa do Consumidor, impõe-se a repetição do indébito em dobro, totalizando 76.478,40 kWh, acrescida de atualização monetária e juros moratórios, a serem apurados até a efetiva restituição.
