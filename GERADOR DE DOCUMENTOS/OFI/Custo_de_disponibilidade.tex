...
\item A Unidade Consumidora \unidadeConsumidora{}, enquadrada na modalidade de Iluminação Pública, vem sendo indevidamente faturada com a cobrança de custo de disponibilidade, prática que afronta a regulamentação vigente e carece de amparo legal.

\item Diante de tal irregularidade, o Requerente apresentou reclamação prévia perante a distribuidora, oportunidade em que colacionou a respectiva fatura de energia elétrica demonstrando, de forma inequívoca, a efetiva incidência e cobrança do referido custo de disponibilidade.

\item A distribuidora indeferiu o pleito administrativo sob a genérica e descabida alegação de não haver a referida cobrança na fatura da Unidade Consumidora, ignorando sumariamente a prova documental expressa acostada ao requerimento.

\item A conduta da concessionária revela flagrante contradição, visto que ao mesmo tempo em que nega a existência do encargo em suas respostas administrativas, persiste emitindo as faturas com a rubrica e exigindo o respectivo pagamento.

\item Cumpre ressaltar que a cobrança perpetrada é manifestamente ilegal. Nos termos do art. 290 da Resolução Normativa nº 1.000/2021, a distribuidora deve proceder ao faturamento da unidade consumidora enquadrada no Grupo B pelo maior valor entre o consumo de energia elétrica ativa e o custo de disponibilidade. Todavia, o § 1º do referido dispositivo estabelece, de forma expressa:
\Citacao{
...
\item Dessa forma, restando provada a cobrança indevida e a recusa injustificada da distribuidora em saná-la, é incontroverso que a conduta carece de respaldo na regulação setorial aplicável, impondo-se a sua imediata correção.
...
\item Assim, uma vez constatada a cobrança indevida e a inércia da concessionária em corrigi-la voluntariamente após ser provocada, incumbe a esta o dever de proceder à revisão e ao refaturamento, com a consequente restituição ao consumidor dos valores pagos a maior.

\item A manutenção de cobrança sabidamente ilegal pela concessionária, mormente após a apresentação de prova cabal pelo usuário, afronta diretamente o princípio da legalidade (art. 37, caput, CF/88), além de caracterizar enriquecimento ilícito, em manifesta violação ao dever de observância da modicidade tarifária.
\end{enumerate}
...
\item Ante o exposto, requer-se:
    ...
    \item Devolva os valores cobrados a maior em dobro, atualizados monetariamente pelo IPCA e juros de mora de 1\% ao mês calculados pro rata die, em conformidade com o estabelecido na Resolução Normativa n° 1.000/2021 da Aneel;
