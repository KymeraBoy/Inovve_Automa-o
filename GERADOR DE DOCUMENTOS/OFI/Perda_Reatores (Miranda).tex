...
% Definição de condicionais para o caso de Miranda/MS (Lâmpadas de Vapor de Sódio e Vapor Metálico)
\newif\ifperdaVapor
\perdaVaportrue
...
\item 
Trata-se de contestação administrativa interposta em face da decisão proferida pela Ouvidoria da Concessionária (Carta nº 2012983143/2026/OUVIDORIA - ENERGISA MS), com vistas à reforma do indeferimento e consequente restituição de valores indevidamente faturados a título de “perdas em reatores” de lâmpadas de vapor de sódio e vapor metálico no faturamento do parque de iluminação pública da Unidade Consumidora nº 83605 (Município de Miranda/MS), apurado por estimativa.

\item
Em sua resposta, a Ouvidoria alegou genericamente que as lâmpadas mencionadas não fariam parte do parque faturado e que não haveria cobrança de perdas de reator. Ocorre que tal alegação diverge frontalmente dos dados oficiais extraídos do próprio Quadro de Iluminação Pública (QIP) mantido e utilizado pela Concessionária como base de faturamento (mês de referência Maio/2021), no qual constam expressamente cadastradas e faturadas 1.307 lâmpadas de Vapor Metálico (70W) e 456 lâmpadas de Vapor de Sódio (70W) com acréscimos indevidos a título de equipamentos auxiliares.
...
\ifperdaVapor
\item % VAPOR
No que se refere às lâmpadas de vapor de sódio e vapor metálico, os percentuais máximos admissíveis de perdas em reatores encontram-se rigorosamente definidos nas normas técnicas da ABNT (em especial as NBR 13593:2011 e NBR 14305:2015), as quais vinculam a atuação da Concessionária e vedam a cobrança de valores superiores aos limites fixados "a frio".
\fi
...
(iv) determinar que a distribuidora envie à ANEEL, num prazo máximo de 15 (quinze) dias após o prazo previsto no item (viii) desta decisão, comprovação do seu cumprimento. (grifou-se)}
...
\begin{enumerate}
    \ifperdaVapor
    \item % VAPOR
    Para reatores de lâmpadas de vapor de sódio e vapor metálico, admite-se, no máximo, a consideração das perdas estritamente previstas nas respectivas normas técnicas da ABNT, aferidas nos termos regulamentares.
    \fi
    \ifperdaFluorescente
    \item % FLUORESCENTE
...
\hline
\textbf{Tipo} & \textbf{Pot. (W)} & \textbf{ABNT NBR 13593} & \textbf{Energisa MS} & \textbf{Dif. (W)} & \textbf{Qtd.} & \textbf{Excedente Mês (kWh)} \\ \hline
VM & 70 & 14,00 W & 15,21 W & 1,21 W & 1.307 & 508,92 \\ \hline
VS & 70 & 14,00 W & 15,21 W & 1,21 W & 456 & 177,41 \\ \hline
\textbf{TOTAL} & - & - & - & - & \textbf{1.763} & \textbf{686,33} \\ \hline
\end{tabular}
\caption{Comparativo de Perdas em Reatores - UC 83605 (Miranda/MS)}
\end{table}
...
<<TABELA FLUORESCENTE>> % FLUORESCENTE
\fi

\item
Os dados e quantitativos acima apresentados foram extraídos do Quadro de Iluminação Pública – QIP, referente a Maio de 2021, em anexo, documento elaborado e utilizado pela própria Concessionária como base de cálculo para o faturamento mensal da unidade consumidora da classe Iluminação Pública (UC 83605). Ressalta-se que referido faturamento é realizado por estimativa, a partir das informações constantes no QIP, circunstância que reforça a necessidade de estrita observância dos limites técnicos e regulatórios aplicáveis, bem como evidencia a improcedência das alegações da Ouvidoria.

\item
Diante do exposto, apura-se a ocorrência de cobrança indevida correspondente a 686,325 kWh/mês, relativa ao parque de iluminação pública considerado no Quadro de Iluminação Pública – QIP. Projetado tal excedente para o período de 120 (cento e vinte) meses, equivalente a 10 (dez) anos, o montante total indevidamente faturado perfaz 82.358,976 kWh. Nos termos do art. 323 da Resolução Normativa ANEEL nº 1.000/2021 e do art. 42, parágrafo único, do Código de Defesa do Consumidor, impõe-se a repetição do indébito em dobro, totalizando 164.717,951 kWh, acrescida de atualização monetária e juros moratórios, a serem apurados até a efetiva restituição.

\item
No que concerne à interpretação do art. 473 da Resolução Normativa ANEEL nº 1.000/2021 — dispositivo que reproduz, em essência, o teor do art. 25 da revogada REN nº 414/2010 —, a ANEEL firmou entendimento no sentido de que as perdas de reatores, quando excepcionalmente admitidas, devem ser calculadas exclusivamente com base nas perdas máximas “a frio” previstas nas normas técnicas da ABNT, sendo expressamente vedadas estimativas “a quente”, percentuais genéricos ou quaisquer acréscimos destituídos de amparo técnico-normativo. Tal orientação encontra-se formalizada, entre outros atos, na Nota Técnica nº 76/2023-SMA/ANEEL e no Despacho nº 1.456/2023-STD/ANEEL, consolidando o entendimento regulatório aplicável ao caso concreto.
\end{enumerate}
...
\item
Ante o exposto, requer-se à Concessionária (e/ou ao Órgão Regulador AGEMS/ANEEL): 

\begin{enumerate}
    \item que receba a presente contestação/recurso e reforme integralmente o parecer emitido pela Ouvidoria (Carta nº 2012983143/2026/OUVIDORIA), promovendo a solução e resposta conclusiva no prazo máximo de 5 (cinco) dias úteis, nos termos do art. 408, I, da REN nº 1.000/2021;
    \item que efetue a devolução integral dos valores indevidamente cobrados a título de “perdas em reatores” referentes às lâmpadas de vapor de sódio e vapor metálico, relativamente aos últimos 10 (dez) anos, contados do primeiro protocolo da reclamação, conforme o Despacho nº 2.006/2024 (aplicação do art. 205 do Código Civil), em dobro (art. 323 da REN nº 1.000/2021 e art. 42, parágrafo único, do CDC), acrescidos de atualização monetária e juros até a efetiva devolução; 
    \item que a devolução se dê por depósito em conta corrente de titularidade do Município de Miranda/MS, na forma do art. 323, § 7º, II, da REN nº 1.000/2021, comunicando-se o cumprimento por escrito ao representante legal; 
    \item que, em observância aos princípios do contraditório e da ampla defesa (CF/88, art.5º, LV), bem como da eficiência e celeridade (Lei nº 9.784/1999, art. 2º), e às regras de representação do consumidor perante a distribuidora/Aneel (REN nº 1.000/2021, art. 9º), todas as comunicações, intimações e notificações relativas a esta reclamação sejam dirigidas exclusivamente ao representante legal do Município que subscreve, preferencialmente pelo e-mail \emailEmpresa{} , reputando-se ineficazes aquelas enviadas a terceiros ou ao antigo representante, por risco de cerceamento de defesa;
